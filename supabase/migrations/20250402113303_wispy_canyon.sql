/*
  # Add April 2025 campaign support

  1. Changes
    - Update campaign_month default to April 2025
    - Add function to handle new campaign registrations
    - Add trigger to automatically set campaign_month for new users

  2. Notes
    - Maintains existing March data
    - Automatically handles campaign assignment for new users
*/
